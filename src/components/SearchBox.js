    ...
    return (
      <>
        <Container maxWidth="sm">
          ...
          >
            <FormLabel component="legend">Get even pickier:</FormLabel>
                ...
                <div className="field testing">
                  <div className="text center">
                    <TextField
                      ...
                      size="large"
                      placeholder="New York, Los Angeles, Japan"
                      value={this.state.location}
                      onChange={(e) =>
                        this.setState({ location: e.target.value })
                      }
                      label="Where Are You Getting Snobby?"
                      variant="outlined"
                    />
                  </div>
                </div>
